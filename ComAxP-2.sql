...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2021 at 07:53 AM
...
CREATE TABLE `customers` (
  ...
  `memberPoint` int(255) UNSIGNED NOT NULL
...
INSERT INTO `customers` (`customerNumber`, `customerName`, `contactLastName`, `contactFirstName`, `phone`, `addressLine1`, `addressLine2`, `city`, `state`, `postalCode`, `country`, `salesRepEmployeeNumber`, `creditLimit`, `memberPoint`) VALUES
...
(144, 'Volvo Model Replicas, Co', 'Berglund', 'Christina ', '0921-12 3555', 'Berguvsvägen  8', NULL, 'Luleå', NULL, 'S-958 22', 'Sweden', 1504, '53100.00', 2412),
...
(169, 'Porto Imports Co.', 'de Castro', 'Isabel ', '(1) 356-5555', 'Estrada da saúde n. 58', NULL, 'Lisboa', NULL, '1756', 'Portugal', NULL, '0.00', 0),
...
(206, 'Asian Shopping Network, Co', 'Walker', 'Brydey', '+612 9411 1555', 'Suntec Tower Three', '8 Temasek', 'Singapore', NULL, '038988', 'Singapore', NULL, '0.00', 0),
...
(223, 'Natürlich Autos', 'Kloss', 'Horst ', '0372-555188', 'Taucherstraße 10', NULL, 'Cunewalde', NULL, '01307', 'Germany', NULL, '0.00', 0),
...
(237, 'ANG Resellers', 'Camino', 'Alejandra ', '(91) 745 6555', 'Gran Vía, 1', NULL, 'Madrid', NULL, '28001', 'Spain', NULL, '0.00', 0),
...
(247, 'Messner Shopping Network', 'Messner', 'Renate ', '069-0555984', 'Magazinweg 7', NULL, 'Frankfurt', NULL, '60528', 'Germany', NULL, '0.00', 0),
...
(293, 'BG&E Collectables', 'Harrison', 'Ed', '+41 26 425 50 01', 'Rte des Arsenaux 41 ', NULL, 'Fribourg', NULL, '1700', 'Switzerland', NULL, '0.00', 0),
...
(356, 'SAR Distributors, Co', 'Kuger', 'Armand', '+27 21 550 3555', '1250 Pretorius Street', NULL, 'Hatfield', 'Pretoria', '0028', 'South Africa', NULL, '0.00', 0),
...
(361, 'Kommission Auto', 'Josephs', 'Karin', '0251-555259', 'Luisenstr. 48', NULL, 'Münster', NULL, '44087', 'Germany', NULL, '0.00', 0),
...
(369, 'Lisboa Souveniers, Inc', 'Rodriguez', 'Lino ', '(1) 354-2555', 'Jardim das rosas n. 32', NULL, 'Lisboa', NULL, '1675', 'Portugal', NULL, '0.00', 0),
...
(465, 'Anton Designs, Ltd.', 'Anton', 'Carmen', '+34 913 728555', 'c/ Gobelas, 19-1 Urb. La Florida', NULL, 'Madrid', NULL, '28023', 'Spain', NULL, '0.00', 0),
...
(477, 'Mit Vergnügen & Co.', 'Moos', 'Hanna ', '0621-08555', 'Forsterstr. 57', NULL, 'Mannheim', NULL, '68306', 'Germany', NULL, '0.00', 0),
...
(481, 'Raanan Stores, Inc', 'Altagar,G M', 'Raanan', '+ 972 9 959 8555', '3 Hagalim Blv.', NULL, 'Herzlia', NULL, '47625', 'Israel', NULL, '0.00', 0),
...
(507, 'ComAxP Company', 'Pherawat', 'Wongsawad', '123456', 'cmu thailand hey', NULL, 'chiang mai', NULL, NULL, 'Thailand', NULL, NULL, 0),
(509, 'ComAxP Company22', 'Pherawat2', 'Wongsawad', '123456', 'chiang mai', NULL, 'chiang mai', NULL, NULL, 'Thailand', NULL, NULL, 0);
...
CREATE TABLE `discountcodes` (
  `discountCode` varchar(8) NOT NULL,
  `startDate` date NOT NULL,
  `endDate` date NOT NULL,
  `amount` int(10) UNSIGNED NOT NULL,
  `discountPrice` int(15) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `discountcodes` (`discountCode`, `startDate`, `endDate`, `amount`, `discountPrice`) VALUES
('COMA1234', '2021-10-08', '2021-10-28', 998, 500);
...
INSERT INTO "employees" ("employeeNumber", "lastName", "firstName", "extension", "email", "officeCode", "reportsTo", "jobTitle", "password") VALUES
(1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', NULL, 'President', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1056, 'Patterson', 'Mary', 'x4611', 'mpatterso@classicmodelcars.com', '1', 1002, 'VP Sales', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1076, 'Firrelli', 'Jeff', 'x9273', 'jfirrelli@classicmodelcars.com', '1', 1002, 'VP Marketing', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1088, 'Patterson', 'William', 'x4871', 'wpatterson@classicmodelcars.com', '6', 1056, 'Sales Manager (APAC)', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1102, 'Bondur', 'Gerard', 'x5408', 'gbondur@classicmodelcars.com', '4', 1056, 'Sale Manager (EMEA)', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1143, 'Bow', 'Anthony', 'x5428', 'abow@classicmodelcars.com', '1', 1056, 'Sales Manager (NA)', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1165, 'Jennings', 'Leslie', 'x3291', 'ljennings@classicmodelcars.com', '1', 1143, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1166, 'Thompson', 'Leslie', 'x4065', 'lthompson@classicmodelcars.com', '1', 1143, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1188, 'Firrelli', 'Julie', 'x2173', 'jfirrelli@classicmodelcars.com', '2', 1143, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1216, 'Patterson', 'Steve', 'x4334', 'spatterson@classicmodelcars.com', '2', 1143, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1286, 'Tseng', 'Foon Yue', 'x2248', 'ftseng@classicmodelcars.com', '3', 1143, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1323, 'Vanauf', 'George', 'x4102', 'gvanauf@classicmodelcars.com', '3', 1143, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1337, 'Bondur', 'Loui', 'x6493', 'lbondur@classicmodelcars.com', '4', 1102, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1370, 'Hernandez', 'Gerard', 'x2028', 'ghernande@classicmodelcars.com', '4', 1102, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1401, 'Castillo', 'Pamela', 'x2759', 'pcastillo@classicmodelcars.com', '4', 1102, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1501, 'Bott', 'Larry', 'x2311', 'lbott@classicmodelcars.com', '7', 1102, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1504, 'Jones', 'Barry', 'x102', 'bjones@classicmodelcars.com', '7', 1102, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1611, 'Fixter', 'Andy', 'x101', 'afixter@classicmodelcars.com', '6', 1088, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1612, 'Marsh', 'Peter', 'x102', 'pmarsh@classicmodelcars.com', '6', 1088, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1619, 'King', 'Tom', 'x103', 'tking@classicmodelcars.com', '6', 1088, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1621, 'Nishi', 'Mami', 'x101', 'mnishi@classicmodelcars.com', '5', 1056, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1625, 'Kato', 'Yoshimi', 'x102', 'ykato@classicmodelcars.com', '5', 1621, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(1702, 'Gerard', 'Martin', 'x2312', 'mgerard@classicmodelcars.com', '4', 1102, 'Sales Rep', '5ebe2294ecd0e0f08eab7690d2a6ee69'),
(2502, 'Apisit', 'Ritruengroj', 'x86', 'khem@hotmail.com', '5', 2503, 'Sales Manager', '$2y$10$8B8tAc9nPlEadYFrmd.APuPm.KapPDm6LOTAgD9Q7DQIu1vTbG71m'),
(2503, 'ApisitLOL', 'TOH', 'x78', 'leng@hotmail.com', '2', NULL, 'Sales Rep', '$2y$10$gUIIepAAn/SQqq3FtfOJaujw3ial2RlF1lbKom/ArOWLncDbg3TFG'),
(2504, 'HONG LENG', 'TOH', 'x78', 'leng2@hotmail.com', '2', NULL, 'VP Sales', '$2y$10$9.MVGIpan033rb2bPE1WKOXAHnJlz7R8Gbfw/I/sRatNuwGRrnwbS');
...
(10439, 'S18_1749', 50, '140.00', 3),
(10440, 'S18_1749', 50, '140.00', 3),
(10441, 'S18_1749', 50, '140.00', 3),
(10442, 'S18_1749', 50, '140.00', 3),
(10443, 'S18_1749', 50, '140.00', 3),
(10444, 'S18_1749', 50, '140.00', 3),
(10445, 'S18_1749', 50, '140.00', 3),
(10446, 'S18_1749', 50, '140.00', 3),
(10447, 'S18_1749', 50, '140.00', 3),
(10448, 'S12_1666', 70, '120.00', 3),
(10448, 'S18_1749', 50, '140.00', 3),
(10448, 'S18_4668', 20, '40.00', 4),
(10449, 'S12_1666', 70, '120.00', 3),
(10449, 'S18_1749', 50, '140.00', 3),
(10449, 'S18_4668', 20, '40.00', 4),
(10451, 'S12_1666', 70, '120.00', 3),
(10451, 'S18_1749', 50, '140.00', 3),
(10451, 'S18_4668', 20, '40.00', 4),
(10452, 'S10_7777', 110, '140.00', 3),
(10453, 'S10_7777', 110, '140.00', 3),
(10454, 'S10_7777', 110, '140.00', 3),
(10455, 'S10_7777', 110, '140.00', 3),
(10456, 'S10_7777', 110, '140.00', 3),
(10457, 'S10_7777', 110, '140.00', 3),
(10458, 'S10_7777', 110, '140.00', 3),
(10459, 'S10_7777', 110, '140.00', 3),
(10462, 'S10_7777', 110, '140.00', 3),
(10464, 'S10_7777', 200, '140.00', 3),
(10465, 'S10_7777', 200, '140.00', 3),
(10466, 'S12_1666', 70, '120.00', 3),
(10466, 'S18_1749', 100, '140.00', 3),
(10466, 'S18_4668', 20, '40.00', 4),
(10467, 'S10_7777', 50, '140.00', 3),
(10468, 'S700_4002', 70, '120.00', 3),
(10468, 'S72_1253', 20, '40.00', 4),
(10468, 'S72_3212', 100, '140.00', 3),
(10471, 'S10_1678', 10, '50.00', 4),
(10471, 'S10_7777', 50, '140.00', 3),
(10473, 'S10_1678', 10, '50.00', 4),
(10473, 'S10_7777', 50, '140.00', 3),
(10474, 'S10_1678', 10, '50.00', 4),
(10474, 'S10_7777', 50, '140.00', 3);
...
CREATE TABLE `orders` (
  ...
  `customerNumber` int(11) NOT NULL,
  `discountCode` varchar(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`, `discountCode`) VALUES
...
(10102, '2003-01-10', '2003-01-18', '2003-01-14', 'Shipped', NULL, 181, NULL),
(10103, '2003-01-29', '2003-02-07', '2003-02-02', 'Shipped', NULL, 121, NULL),
(10104, '2003-01-31', '2003-02-09', '2003-02-01', 'Shipped', NULL, 141, NULL),
(10105, '2003-02-11', '2003-02-21', '2003-02-12', 'Shipped', NULL, 145, NULL),
(10106, '2003-02-17', '2003-02-24', '2003-02-21', 'Shipped', NULL, 278, NULL),
(10107, '2003-02-24', '2003-03-03', '2003-02-26', 'Shipped', 'Difficult to negotiate with customer. We need more marketing materials', 131, NULL),
(10108, '2003-03-03', '2003-03-12', '2003-03-08', 'Shipped', NULL, 385, NULL),
(10109, '2003-03-10', '2003-03-19', '2003-03-11', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 486, NULL),
(10110, '2003-03-18', '2003-03-24', '2003-03-20', 'Shipped', NULL, 187, NULL),
(10111, '2003-03-25', '2003-03-31', '2003-03-30', 'Shipped', NULL, 129, NULL),
(10112, '2003-03-24', '2003-04-03', '2003-03-29', 'Shipped', 'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 144, NULL),
(10113, '2003-03-26', '2003-04-02', '2003-03-27', 'Shipped', NULL, 124, NULL),
(10114, '2003-04-01', '2003-04-07', '2003-04-02', 'Shipped', NULL, 172, NULL),
(10115, '2003-04-04', '2003-04-12', '2003-04-07', 'Shipped', NULL, 424, NULL),
(10116, '2003-04-11', '2003-04-19', '2003-04-13', 'Shipped', NULL, 381, NULL),
...
(10119, '2003-04-28', '2003-05-05', '2003-05-02', 'Shipped', NULL, 382, NULL),
(10120, '2003-04-29', '2003-05-08', '2003-05-01', 'Shipped', NULL, 114, NULL),
(10121, '2003-05-07', '2003-05-13', '2003-05-13', 'Shipped', NULL, 353, NULL),
(10122, '2003-05-08', '2003-05-16', '2003-05-13', 'Shipped', NULL, 350, NULL),
...
(10125, '2003-05-21', '2003-05-27', '2003-05-24', 'Shipped', NULL, 114, NULL),
...
(10130, '2003-06-16', '2003-06-24', '2003-06-21', 'Shipped', NULL, 198, NULL),
...
(10167, '2003-10-23', '2003-10-30', NULL, 'Cancelled', 'Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.', 448, NULL),
...
(10179, '2003-11-11', '2003-11-17', '2003-11-13', 'Cancelled', 'Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.', 496, NULL),
...
(10248, '2004-05-07', '2004-05-14', NULL, 'Cancelled', 'Order was mistakenly placed. The warehouse noticed the lack of documentation.', 131, NULL),
...
(10253, '2004-06-01', '2004-06-09', '2004-06-02', 'Cancelled', 'Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.', 201, NULL),
...
(10260, '2004-06-16', '2004-06-22', NULL, 'Cancelled', 'Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.', 357, NULL),
(10261, '2004-06-17', '2004-06-25', '2004-06-22', 'Shipped', NULL, 233, NULL),
(10262, '2004-06-24', '2004-07-01', NULL, 'Cancelled', 'This customer found a better offer from one of our competitors. Will call back to renegotiate.', 141, NULL),
...
(10341, '2004-11-24', '2004-12-01', '2004-11-29', 'Shipped', NULL, 382, NULL),
...
(10367, '2005-01-12', '2005-01-21', '2005-01-16', 'Resolved', 'This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.', 205, NULL),
...
(10420, '2005-05-29', '2005-06-07', NULL, 'In Process', NULL, 282, NULL),
(10421, '2005-05-29', '2005-06-06', NULL, 'In Process', 'Custom shipping instructions were sent to warehouse', 124, NULL),
(10422, '2005-05-30', '2005-06-11', NULL, 'In Process', NULL, 157, NULL),
(10423, '2005-05-30', '2005-06-05', NULL, 'In Process', NULL, 314, NULL),
(10424, '2005-05-31', '2005-06-08', NULL, 'In Process', NULL, 141, NULL),
(10425, '2005-05-31', '2005-06-07', NULL, 'In Process', NULL, 119, NULL),
(10439, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10440, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10441, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10442, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10443, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10444, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10445, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10446, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10447, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10448, '2021-09-26', '2021-09-30', '2021-09-28', 'Wait', 'haha', 144, NULL),
(10449, '2021-09-26', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10451, '2021-09-27', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10452, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10453, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10454, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10455, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10456, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10457, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10458, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10459, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10460, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10461, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10462, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10463, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10464, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10465, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10466, '2021-09-28', '2021-09-30', '2021-09-28', 'in process', 'haha', 144, NULL),
(10467, '2021-09-29', '2021-10-30', '2021-10-28', 'shipped', 'haha', 144, NULL),
(10468, '2021-09-29', '2021-10-30', '2021-10-28', 'shipped', 'haha', 144, NULL),
(10471, '2021-10-07', '2021-10-30', '2021-10-28', 'on hold', 'haha', 144, NULL),
(10473, '2021-10-08', '2021-10-30', '2021-10-28', 'on hold', 'haha', 144, 'COMA1234'),
(10474, '2021-10-08', '2021-10-30', '2021-10-28', 'on hold', 'haha', 144, 'COMA1234');
...
(144, 'HQ336337', '2021-10-07', '7000.00', 10471),
(144, 'LD356355', '2021-10-08', '7000.00', 10473),
(144, 'LD356358', '2021-10-08', '7000.00', 10474);
...
(20, 'App\\Models\\Employee', 2000, 'firstName lastName', '3264bc1baca0c136f41599412985e0124e03a134ba65b3fe04b9ad9c66e91c60', '[\"janitor\"]', NULL, '2021-09-25 06:50:18', '2021-09-25 06:50:18'),
(21, 'App\\Models\\Employee', 2500, 'firstNaem Apisit', '1ce225c9a02ee2b7eea3ca25957c25f2fc99608109992379f9fee811186e823e', '[\"janitor\"]', '2021-09-27 00:20:23', '2021-09-27 00:19:51', '2021-09-27 00:20:23'),
(23, 'App\\Models\\Employee', 2502, 'Ritruengroj Apisit', '9d5865c1baabdc02472358838667b429782592410876a4f09a35809afdb7cc92', '[\"Sales Rep\"]', '2021-09-29 07:51:09', '2021-09-29 07:28:12', '2021-09-29 07:51:09'),
(27, 'App\\Models\\Employee', 2503, 'TOH HONG LENG', '7ef4a4c96c5060cf68348255e6fbcd96b40b000a3e9fb46c3615d1e2079cbbed', '[\"employee\",\"President\"]', NULL, '2021-10-06 21:09:14', '2021-10-06 21:09:14'),
(28, 'App\\Models\\Employee', 2503, 'TOH HONG LENG', '1c5c02078e99a22e9323d3313142463263537925c53be7a2c04cf252fd679d87', '[\"employee\",\"President\"]', '2021-10-06 21:09:39', '2021-10-06 21:09:14', '2021-10-06 21:09:39'),
(32, 'App\\Models\\Employee', 2504, 'TOH HONG LENG', 'd2a5bfa067bae894c13d308d0b2e9155a40be4e6f7bad3aa188de288af5acca4', '[\"Employee\",\"HR\",\"Salesman\"]', '2021-10-08 07:37:08', '2021-10-06 21:37:44', '2021-10-08 07:37:08');
...
CREATE TABLE `preorders` (
  `orderNumber` int(11) NOT NULL,
  `upfrontPrice` int(15) UNSIGNED NOT NULL,
  `ratio` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('S10_1678', '1969 Harley Davidson Ultimate Chopper', 'Motorcycles', '1:10', 'Min Lin Diecast', 'This replica features working kickstand, front suspension, gear-shift lever, footbrake lever, drive chain, wheels and steering. All parts are particularly delicate due to their precise scale and require special care and attention.', 7893, '48.81', '95.70'),
...
('S10_7777', 'Kubota', 'Trucks and Buses', '1:10', 'asd', 'asd', 350, '200.00', '500.00'),
...
('S700_4002', 'American Airlines: MD-11S', 'Planes', '1:700', 'Second Gear Diecast', 'Polished finish. Exact replia with official logos and insignias and retractable wheels', 8190, '36.27', '74.03'),
('S72_1253', 'Boeing X-32A JSF', 'Planes', '1:72', 'Motor City Art Classics', '10\" Wingspan with retractable landing gears.Comes with pilot', 4817, '32.77', '49.66'),
...
ALTER TABLE `payments`
  ...
  ADD KEY `payments_ibfk_2` (`orderNumber`);
...
--
ALTER TABLE `customers`
  MODIFY `customerNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=511;

--
-- AUTO_INCREMENT for table `employees`
--
ALTER TABLE `employees`
  MODIFY `employeeNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2505;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `orderNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10475;
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employees` (`employeeNumber`) ON UPDATE CASCADE;

--
-- Constraints for table `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `employees` (`employeeNumber`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `orderdetails`
  ...
  ADD CONSTRAINT `orderdetails_ibfk_2` FOREIGN KEY (`productCode`) REFERENCES `products` (`productCode`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`discountCode`) REFERENCES `discountcodes` (`discountCode`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `payments`
--
ALTER TABLE `payments`
  ADD CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`customerNumber`) REFERENCES `customers` (`customerNumber`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`orderNumber`) REFERENCES `orders` (`orderNumber`) ON UPDATE CASCADE;

--
-- Constraints for table `preorders`
--
ALTER TABLE `preorders`
  ADD CONSTRAINT `preorders_ibfk_1` FOREIGN KEY (`orderNumber`) REFERENCES `orders` (`orderNumber`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `products`
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`productLine`) REFERENCES `productlines` (`productLine`) ON UPDATE CASCADE;
COMMIT;
